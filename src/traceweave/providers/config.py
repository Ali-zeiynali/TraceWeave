    ...
    if path.exists():
        ...
        for p in raw.get("providers", []):
            ...
            for m in p.get("models", []):
                ...
                models.append(
                    ModelConfig(
                        id=str(m["id"]),
                        name=str(m["name"]),
                        tasks=_strings(m.get("tasks"), ["*"]),
                        capabilities=_strings(m.get("capabilities")),
                        credentials=_strings(m.get("credentials")),
            ...
            explicit = ProviderConfig(
                id=str(p["id"]),
                driver=str(p.get("driver", "openai_compat")),
